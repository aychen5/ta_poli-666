...
- Law of Large Numbers: If $X_1,...,X_n$ are drawn independently from the distribution of $X$ (randomly sampled), then the sample estimator for the mean converges in probability to the population average of $X$ <footnote>$\bar{X_n} \overset{p}{\to} \mathbb{E}[X]$ as $n \to \infty$, assuming the expected value exists $\mathbb{E}[X] < \infty$</footnote>
